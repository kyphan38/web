...
- Colleague: "What if I dislike the default token hierarchy or my app can't handle it?"
  - Response: "Alternative options are available"
...
- DevOps: "My app can't use a token affected by its parent's expiration"
...
```bash
vault token lookup s.ya32UrL0ASLkvIOLsM5mVl9c
---
Key             Value
---             -----
...
Key   Value
---   -----
token s.516LO9Ssk1CQzvKo8ny1G0eu

vault token lookup s.516LO9Ssk1CQzvKo8ny1G0eu
---
Key        Value
---        -----
id         s.516LO9Ssk1CQzvKo8ny1G0eu
...
- Every token has an associated accessor, a reference used for limited actions
  ...
  - Renew the token
  - Revoke the token
- Note: Accessors cannot authenticate to Vault or perform additional requests
