...
| state-run health insurance program (chuong trinh bao hiem nha nuoc) | /steɪt rʌn hɛlθ ɪnˈʃʊrəns ˈproʊɡræm/ | public healthcare (bao hiem cong), government insurance (bao hiem chinh phu)      | The state-run health insurance program helped millions |
